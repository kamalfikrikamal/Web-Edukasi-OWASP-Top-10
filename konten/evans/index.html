...
<html lang="en">
  ...
  <body>
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">WEOT10</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item"><a href="work.html" class="nav-link">OWASP Top 10</a></li>
    ...
    <section id="home-section" class="hero">
    	<h1 class="vr text-center">BSSN</h1>
			      ...
			      <div class="slider-item js-fullheight">
			        ...
			        <div class="container-fluid p-0">
			          <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
			          	<div class="one-third img js-fullheight" style="background-image:url(images/bg_1.jpeg);">
			          	</div>
			        	</div>
			        </div>
			      </div>
			      ...
			      <div class="slider-item js-fullheight">
			        ...
			        <div class="container-fluid p-0">
			          <div class="row d-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
			          	<div class="one-third img js-fullheight" style="background-image:url(images/#);">
			          		<div class="overlay"></div>
			          	</div>
			        	</div>
			        </div>
    ...
    <section class="ftco-section ftco-portfolio">
    		...
    		<div class="row no-gutters">
	  			<div class="col-md-12 portfolio-wrap">
	  				<div class="row no-gutters align-items-center">
	  					<div class="col-md-5 img js-fullheight" style="background-image: url(images/1.png);">
	  							...
	  							<div class="px-4 px-lg-4">
	  								<div class="desc">
		  								<div class="top">
				  							...
				  							<h2 class="mb-4"><a href="work.html">Injection</a></h2>
			  							</div>
			  							<div class="absolute">
				  							...
				  							<p><a href="a1.html" class="custom-btn">Lebih Lengkap</a></p>
			  							</div>
		  							</div>
	  							</div>
	  						</div>
    	...
    	<div class="container-fluid px-0 portfolio-entry">
    		<div class="row no-gutters d-xl-flex justify-content-end text-wrapper">
					<div class="one-half img js-fullheight" style="background-image: url('images/#');"></div>
              ...
              <div class="desc pt-5 pl-4 pr-4 pt-lg-0 pl-lg-5 pl-xl-0 pr-xl-0">
								<div class="top">
	  							...
	  							<h2 class="mb-4"><a href="work.html">Broken Authentication</a></h2>
  							</div>
  							<div class="absolute">
	  							...
	  							<p><a href="a2.html" class="custom-btn">Lebih Lengkap</a></p>
  							</div>
							</div>
            </div>
					</div>
    		...
    		<div class="row no-gutters d-md-flex justify-content-start text-wrapper">
              ...
              <div class="desc pt-5 pr-4 pl-4 pt-lg-0 pr-lg-5 pr-xl-0 pl-xl-0">
								<div class="top">
	  							...
	  							<h2 class="mb-4"><a href="work.html">Sensitive Data Exposure</a></h2>
  							</div>
  							<div class="absolute">
	  							...
	  							<p><a href="a3.html" class="custom-btn">Lebih Lengkap</a></p>
  							</div>
							</div>
            </div>
					</div>
    	...
    	<div class="container">
    		<div class="row no-gutters">
	  			<div class="col-md-12 portfolio-wrap">
	  				<div class="row no-gutters align-items-center">
	  					<div class="col-md-5 order-md-last img js-fullheight" style="background-image: url(images/1.png);">
	  							...
	  							<div class="px-4 px-lg-4">
	  								<div class="desc">
		  								<div class="top">
				  							...
				  							<h2 class="mb-4"><a href="work.html">XML External Entities (XEE)</a></h2>
			  							</div>
			  							<div class="absolute">
				  							...
				  							<p><a href="a4.html" class="custom-btn">Lebih Lengkap</a></p>
			  							</div>
		  							</div>
	  							</div>
	  						</div>
    		...
    		<div class="row no-gutters d-md-flex justify-content-end text-wrapper">
              ...
              <div class="desc pt-5 pl-5 pr-5 pt-lg-0 pl-lg-5 pl-xl-0 pr-xl-0">
								<div class="top">
	  							...
	  							<h2 class="mb-4"><a href="work.html">Broken Access Control</a></h2>
  							</div>
  							<div class="absolute">
	  							...
	  							<p><a href="a5.html" class="custom-btn">Lebih Lengkap</a></p>
  							</div>
							</div>
            </div>
					</div>
