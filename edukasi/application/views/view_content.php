...
<body>
    <div class="container">
        ...
        <form method="POST" action="<?php echo site_url('komentar/kirim') ?>">
            ...
            <button class="w3-button w3-block w3-black w3-section w3-padding" type="submit">Kirim Komentar</button>
        </form>
    </div>
    <?php
    ...
    ?>
    <div class="container">
        <div class="w3-panel w3-pale-black w3-leftbar w3-border-black">
            <p>
                <b><?php echo $utama->comment_nama?></b>
                <br><?php echo $utama->comment_isi?>
                <br><button class="w3-button w3-tiny w3-black" onclick="document.getElementById('<?php echo $utama->comment_id?>').style.display='block'">Balas</button>
            </p>
        </div>
    </div>
        <?php
        ...
        ?>
        <div class="container">
            <div class="w3-panel w3-pale-black w3-leftbar w3-border-black child">
                <p>
                ...
                <div class="w3-container">
                    <form class="w3-container" method="POST" action="<?php echo site_url('komentar/balas') ?>">
                        ...
                        <div class="w3-section">
                            ...
                            <br>         
                            <textarea style="width: 100%;" name="isi"></textarea>
                            <button class="w3-button w3-block w3-black w3-section w3-padding" type="submit">Kirim</button>
                        </div>
                    </form>
                </div>
                <footer class="w3-container w3-black w3-border-top w3-padding-16"></footer>
            </div>
        </div>
    <?php endforeach;?>
