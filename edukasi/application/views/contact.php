	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
          ...
          <li class="nav-item"><a href="<?php echo site_url('./')?>" class="nav-link">Home</a></li>
	          ...
	          <li class="nav-item active"><a href="<?php echo site_url('contact')?>" class="nav-link">Contact</a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="<?php echo site_url('./')?>">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>About us <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row no-gutters d-flex contact-info">
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
          		...
          		<h3 class="mb-4">Alamat Kantor</h3>
	            <p>Jalan Raya Muchtar 70
          ...
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="tel:+6221 77973360">+6221 77973360</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
          		...
          		<h3 class="mb-4">Surel</h3>
	            <p><a href="mailto:humas@bssn.go.id">humas[at]bssn.go.id</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="https://bssn.go.id/">https://bssn.go.id/</a></p>
	          </div>
          </div>
        </div>
      </div>
