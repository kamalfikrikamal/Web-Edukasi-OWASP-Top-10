...
<html lang="en">
			      ...
			      <div class="slider-item js-fullheight">
			        ...
			        <div class="container-fluid p-0">
			          <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
			          	<div class="one-third img js-fullheight" style="background-image:url(assets/images/bg_1.jpeg);">
			          	</div>
			        	</div>
			        </div>
			      </div>
			      ...
			      <div class="slider-item js-fullheight">
			        ...
			        <div class="container-fluid p-0">
			          <div class="row d-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
			          	<div class="one-third img js-fullheight" style="background-image:url(assets/images/#);">
			          		<div class="overlay"></div>
			          	</div>
			        	</div>
			        </div>
    ...
    <section class="ftco-section ftco-intro">
    	<div class="container">
    		<div class="row justify-content-end">
    			<div class="col-md-8">
    				<h2>Web <span>Edukasi</span> OWASP Top 10 oleh <span> Badan Siber dan Sandi Negara</span></h2>
    			</div>
    		</div>
    	</div>
    </section>
          ...
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Apa Itu Software Development Life Cycle?</h3>
                <p>Software Development Life Cycle (SDLC) adalah tahapan seorang pengembang perangkat lunak dalam mengembangkan perangkat lunaknya kepada klien dimulai dari perencanaan sampai dengan ke tahap maintenance.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services active d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Apa Manfaat Penggunaan Software Development Life Cycle?</h3>
                <p>
					1. Memperjelas alur, peran setiap orang, dan tujuan dari projek yang sedang dikerjakan
				</p>
				<p>2. Meminimalisir kesalahan dengan adanya tahap pengujian sebelum perangkat lunak digunakan
				</p>
				<p>3. Pengembangan projek dapat terus berlangsung sampai menemukan hasil yang sempurna
				</p>
				<p>4. Dokumentasi projek menjadi jelas sehingga projek perangkat lunak yang sama dapat diulang atau dilanjutkan oleh siapa saja
				</p>
				<p>5. Estimasi waktu dan sumber daya bisa ditentukan sebelum projek dikerjakan</p>
              </div>
            </div>    
          </div>
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Apa Itu Secure Software Development Life Cycle?</h3>
                <p>Secure Software Development Life Cycle (SSDLC) adalah pengembangan dari SDLC sebelumnya dengan menambahkan kegiatan pengamanan seperti penetration testing, reviu kode, dan analisis arsitektur pada tahap pengembangannya, tidak hanya pada tahap pengujiannya saja.</p>
              </div>
            </div>      
          </div>
          <div class="col-md-6 col-lg-3 d-flex align-self-stretch ftco-animate">
            <div class="media block-6 services active-2 d-block">
              ...
              <div class="media-body">
                <h3 class="heading mb-3">Kenapa Ada Secure Software Development Life Cycle?</h3>
				<p>Tahap pengujian keamanan yang difokuskan pada satu tahap saja, yaitu pengujian, menimbulkan beberapa permasalahan keamanan yang baru ditemukan sangat banyak dan membutuhkan usaha lebih untuk memperbaikinya. </p>
				<p>Bahkan beberapa celah keamanan tidak terdeteksi sama sekali dan pada akhirnya menimbulkan kerugian besar. </p>
				<p>Diantara banyak kerawanan yang ada, Open Web Application Security Project (OWASP) mempublikasikan 10 kerentanan yang sering muncul pada aplikasi web yaitu OWASP Top 10 yang terdiri dari Injection, Broken Authentication, Sensitive Data Exposure, XML External Entities (XEE), Broken Access Control, Security Misconfiguration, Cross-Site Scripting (XSS), Insecure Desentralization, Using Components with Known Vulnerabilities, Insufficient Logging & Monitoring.</p>
              </div>
            </div>      
          </div>
        </div>
    ...
    <section class="ftco-section ftco-portfolio">
    	<div class="container-fluid">
          ...
          <div class="col-md-12 mb-5 heading-section text-center ftco-animate">
            <h2 class="mb-5">OWASP<span>Top 10</span></h2>
          </div>
        </div>
    	</div>
    		...
    		<div class="row no-gutters">
	  			<div class="col-md-12 portfolio-wrap">
	  				<div class="row no-gutters align-items-center">
	  					<div class="col-md-5 img js-fullheight" style="background-image: url(assets/images/1.png);">
	  							...
	  							<div class="px-4 px-lg-4">
	  								<div class="desc">
		  								<div class="top">
				  							...
				  							<h2 class="mb-4"><a href="<?php echo site_url('work')?>">Injection</a></h2>
			  							</div>
			  							<div class="absolute">
    	...
    	<div class="container-fluid px-0 portfolio-entry">
    		<div class="row no-gutters d-xl-flex justify-content-end text-wrapper">
					<div class="one-half img js-fullheight" style="background-image: url('assets/images/#');"></div>
              ...
              <div class="desc pt-5 pl-4 pr-4 pt-lg-0 pl-lg-5 pl-xl-0 pr-xl-0">
								<div class="top">
	  							...
	  							<h2 class="mb-4"><a href="<?php echo site_url('work')?>">Broken Authentication</a></h2>
  							</div>
  							<div class="absolute">
    		...
    		<div class="row no-gutters d-md-flex justify-content-start text-wrapper">
              ...
              <div class="desc pt-5 pr-4 pl-4 pt-lg-0 pr-lg-5 pr-xl-0 pl-xl-0">
								<div class="top">
	  							...
	  							<h2 class="mb-4"><a href="<?php echo site_url('work')?>">Sensitive Data Exposure</a></h2>
  							</div>
  							<div class="absolute">
    	...
    	<div class="container">
    		<div class="row no-gutters">
	  			<div class="col-md-12 portfolio-wrap">
	  				<div class="row no-gutters align-items-center">
	  					<div class="col-md-5 order-md-last img js-fullheight" style="background-image: url(assets/images/1.png);">
	  							...
	  							<div class="px-4 px-lg-4">
	  								<div class="desc">
		  								<div class="top">
				  							...
				  							<h2 class="mb-4"><a href="<?php echo site_url('work')?>">XML External Entities (XEE)</a></h2>
			  							</div>
			  							<div class="absolute">
    		...
    		<div class="row no-gutters d-md-flex justify-content-end text-wrapper">
              ...
              <div class="desc pt-5 pl-5 pr-5 pt-lg-0 pl-lg-5 pl-xl-0 pr-xl-0">
								<div class="top">
	  							...
	  							<h2 class="mb-4"><a href="<?php echo site_url('work')?>">Broken Access Control</a></h2>
  							</div>
  							<div class="absolute">
			...
			<div class="col-md">
			  <div class="ftco-footer-widget mb-4">
				...
				<ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
				  <li class="ftco-animate"><a href="assets/https://twitter.com/bssn_ri"><span class="icon-twitter"></span></a></li>
				  <li class="ftco-animate"><a href="assets/https://www.facebook.com/badansiberdansandinegara/"><span class="icon-facebook"></span></a></li>
				  <li class="ftco-animate"><a href="assets/https://www.instagram.com/bssn_ri/"><span class="icon-instagram"></span></a></li>
				</ul>
			  </div>
			</div>
			<div class="col-md">
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="assets/https://colorlib.com" target="_blank">Colorlib</a>
