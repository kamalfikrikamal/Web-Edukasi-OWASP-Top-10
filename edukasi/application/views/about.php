	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
          ...
          <li class="nav-item"><a href="<?php echo site_url('./')?>" class="nav-link">Home</a></li>
	        	<li class="nav-item active"><a href="<?php echo site_url('about')?>" class="nav-link">About</a></li>
    	...
    	<div class="container">
    		<div class="row justify-content-end">
    			<div class="col-md-4 d-flex">
    				<div class="img" style="background-image: url('assets/images/bg_2.png')"></div>
    			</div>
    			<div class="col-md-8 py-md-5 pt-4 p-md-5">
    				<h2>Badan <span>Siber</span> dan <span>Sandi</span> Negara</h2>
              ...
              <p>BSSN mempunyai tugas melaksanakan keamanan siber secara efektif dan efisien dengan memanfaatkan, mengembangkan, dan mengonsolidasikan semua unsur yang terkait dengan keamanan siber.</p>
    				<p><a href="<?php echo site_url('contact')?>" class="btn btn-primary">Contact Us</a></p>
    			</div>
    		</div>
    	</div>
    </section>
